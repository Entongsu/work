...
while True:
    ...
    node_x2= xt.to_numpy()
    node_x3 = xt1.to_numpy()
    gui.circles(node_x2, radius=2, color=0xDC143C)
    gui.circles(node_x3, radius=2, color=0xDC143C)
    ...
    for i in range(n_vertices_x):
        for j in range(n_vertices_y-1):
            gui.line(x[mesh(i,j)],x[mesh(i,j+1)],radius=0.6,color=0x00BFFF)
            gui.line(x1[mesh(i,j)],x1[mesh(i,j+1)],radius=0.6,color=0xFF0000)
    for i in range(n_vertices_x-1):
        for j in range(n_vertices_y):
            gui.line(x[mesh(i,j)],x[mesh(i+1,j)],radius=0.6,color=0x00BFFF)
            gui.line(x1[mesh(i,j)],x1[mesh(i+1,j)],radius=0.6,color=0xFF0000)
    for i in range(n_vertices_x-1):
        for j in range(n_vertices_y-1):
            gui.line(x[mesh(i,j)],x[mesh(i+1,j+1)],radius=0.6,color=0x00BFFF)
            gui.line(x1[mesh(i,j)],x1[mesh(i+1,j+1)],radius=0.6,color=0xFF0000)
    for i in range(1,n_vertices_x):
        for j in range(0,n_vertices_y-1):
            gui.line(x[mesh(i,j)],x[mesh(i-1,j+1)],radius=0.6,color=0x00BFFF)
            gui.line(x1[mesh(i,j)],x1[mesh(i-1,j+1)],radius=0.6,color=0xFF0000)
    ...
    for i in range(tank_size_x):
        for j in range(tank_size_y-1):
            gui.line(xt[mesh(i,j)],xt[mesh(i,j+1)],radius=0.6,color=0x000000)
            gui.line(xt1[mesh(i,j)],xt1[mesh(i,j+1)],radius=0.6,color=0x000000)
    for i in range(tank_size_x-1):
        for j in range(tank_size_y):
            gui.line(xt[mesh(i,j)],xt[mesh(i+1,j)],radius=0.6,color=0x000000)
            gui.line(xt1[mesh(i,j)],xt1[mesh(i+1,j)],radius=0.6,color=0x000000)
    for i in range(tank_size_x-1):
        for j in range(tank_size_y-1):
